...
def generate_time_vs_tasks_graph_new(prog_csv,prog_on_opt_csv,opt_on_opt_csv,prog_on_altered_opt_csv):
    fig, ax = plt.subplots()
...
def main(args):
    if len(args) == 5:
        prog_filepath = args[1]
        prog_on_opt_filepath = args[2]
        opt_on_opt_filepath = args[3]
        prog_on_altered_filepath = args[4]
        prog_csv = retrieve_csv(prog_filepath)
        prog_on_opt_csv = retrieve_csv(prog_on_opt_filepath)
        opt_on_opt_csv = retrieve_csv(opt_on_opt_filepath)
        prog_on_altered_opt_csv = retrieve_csv(prog_on_altered_filepath)
        ensure_dir(generated_graphs_base)
        generate_time_vs_tasks_graph_opt(prog_csv,prog_on_opt_csv,opt_on_opt_csv,prog_on_altered_opt_csv)
        generate_time_vs_tasks_graph_new(prog_csv,prog_on_opt_csv,opt_on_opt_csv,prog_on_altered_opt_csv)
    else:
        print_usage(args)
