...
(* OASIS_START *)
(* DO NOT EDIT (digest: f1e05f347f363402c327c79e34488f52) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build ["-use-ocamlfind"; "-cflags"; "-rectypes"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Solomon Aduol Maina <smaina@seas.upenn.edu>"];
          authors =
            [
               "https://github.com/SolomonAduolMaina/boomerang/graphs/contributors"
            ];
          homepage = Some "http://www.seas.upenn.edu/~harmony/";
          bugreports = Some "https://github.com/SolomonAduolMaina/boomerang";
          synopsis = "The Boomerang Language";
          description =
            Some
              [
                 OASISText.Para
                   "Boomerang is a programming language for writing lenses\226\128\148well-behaved bidirectional transformations\226\128\148that operate on ad-hoc, textual data formats."
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/SolomonAduolMaina/boomerang";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "hbase";
                           FindlibPackage ("str", None);
                           InternalLibrary "ubase";
                           InternalLibrary "lenssynth"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "hbase"; InternalLibrary "boomerang"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ubase";
                           InternalLibrary "boomerang";
                           InternalLibrary "lenses"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "boomerang.ml"});
               Executable
                 ({
                     cs_name = "baker";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [InternalLibrary "ubase"; InternalLibrary "hbase"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "baker.ml"})
            ];
     ...
     oasis_digest = Some "n\246\252\237\174\189<8\247\"\187\138\133^\132\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
