...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3173bc728fef028dca242037be079bb6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["https://github.com/boomerang-lang/boomerang/contributors"];
          homepage = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("core", None)];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\137\208\174\212\168\164\015\199<sE\165t\187\151}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
